...
public class TechnologyLabelSpecJoinFetch implements Specification<TechnologyLabel> {
    ...
    public TechnologyLabelSpecJoinFetch(FilterParamsDTO searchCriteria) {
        this.searchCriteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<TechnologyLabel> root, CriteriaQuery<?> cq, CriteriaBuilder cb) {

        List<Predicate> predicates = new ArrayList<>();

        Join<Object, Object> labelJoin = (Join<Object, Object>) root.fetch("label", JoinType.INNER);
        Join<Object, Object> technologyJoin = (Join<Object, Object>) root.fetch("technology", JoinType.INNER);
