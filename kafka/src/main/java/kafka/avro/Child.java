...
public class Child extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1122458994862282078L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Child\",\"namespace\":\"kafka.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<Child> ENCODER =
      new BinaryMessageEncoder<Child>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<Child> DECODER =
      new BinaryMessageDecoder<Child>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<Child> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<Child>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public Child(java.lang.CharSequence name) {
    this.name = name;
  }
   ...
   */
  public static kafka.avro.Child.Builder newBuilder() {
    return new kafka.avro.Child.Builder();
  }
   ...
   * @return A new Child RecordBuilder
   */
  public static kafka.avro.Child.Builder newBuilder(kafka.avro.Child.Builder other) {
    if (other == null) {
      return new kafka.avro.Child.Builder();
    } else {
      return new kafka.avro.Child.Builder(other);
    }
  }
   ...
   * @return A new Child RecordBuilder
   */
  public static kafka.avro.Child.Builder newBuilder(kafka.avro.Child other) {
    if (other == null) {
      return new kafka.avro.Child.Builder();
    } else {
      return new kafka.avro.Child.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Child>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(kafka.avro.Child.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(kafka.avro.Child other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.avro.Child.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.avro.Child.Builder clearName() {
      name = null;
